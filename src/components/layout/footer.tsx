      ...
      <div className="container-app py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-3 no-underline" aria-label={`${APP_NAME} — Home`}>
          ...
          <nav className="space-y-3" aria-label="Footer navigation">
            ...
            {[
              ...
              { label: "Offers & Promos", href: "/?tab=offers" },
            ].map((link) => (
              <Link
                key={link.label}
                href={link.href}
                className="block text-[14px] text-white/60 hover:text-[#0B70D5] transition-colors no-underline"
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-[13px] text-white/60">
                ...
                <a href={`tel:${BUSINESS.phone}`} className="text-white/60 hover:text-[#0B70D5] transition-colors no-underline">
                  {BUSINESS.phone}
                </a>
              </div>
              <div className="flex items-center gap-3 text-[13px] text-white/60">
                <Mail className="w-4 h-4 text-[#0B70D5] shrink-0" />
                <a href={`mailto:${BUSINESS.email}`} className="text-white/60 hover:text-[#0B70D5] transition-colors no-underline">
                  {BUSINESS.email}
                </a>
              </div>
            </div>
