...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.log("[CREATE-ORDER] amount:", serverFinalAmount.toFixed(2));
    console.log("[CREATE-ORDER] callbackUrl:", callbackUrl);
    console.log("[CREATE-ORDER] APP_URL:", APP_URL);
    ...
    try {
      ...
      console.error("[CREATE-ORDER] FULL ERROR:", JSON.stringify(paytmErr, Object.getOwnPropertyNames(paytmErr)));
