...
export default function AddMoviePage() {
  ...
  const [form, setForm] = useState({
    ...
    is_featured: false, is_active: true, genre: [] as string[],
  });
  ...
  return (
    <PageTransition>
      <div className="max-w-3xl">
        ...
        <h1 className="font-display text-2xl font-bold mb-6">Add New Movie</h1>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2 md:col-span-2">
                  <Label>Title *</Label>
                  <Input value={form.title} onChange={(e) => updateField("title", e.target.value)} placeholder="Movie title" />
                </div>
                <div className="space-y-2 md:col-span-2">
                  <Label>Description</Label>
                  <Textarea value={form.description} onChange={(e) => updateField("description", e.target.value)} placeholder="Movie description..." rows={4} />
                </div>
                ...
                <div className="space-y-2">
                  <Label>Rating</Label>
                  <Select value={form.rating} onValueChange={(v) => updateField("rating", v)}>
                    <SelectTrigger><SelectValue /></SelectTrigger>
                    <SelectContent>
          ...
          <Card className="bg-surface border-border">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2 mt-4">
                ...
                <Input value={form.trailer_url} onChange={(e) => updateField("trailer_url", e.target.value)} placeholder="https://youtube.com/watch?v=..." />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted">Show this movie on the public site</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted">Show in the hero carousel</p>
                </div>
